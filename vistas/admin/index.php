...
<body>
    <div class="sidebar">
    <h1 style="text-align:center;font-size:30px;color:white;">Bienvenido Administrador</h1>
        <a href="../../index.html">Cerrar Sesión</a>
        <a href="listar/lista_usuarios.php">Lista de usuarios</a>
    ...
    <div class="content">
        <h2 style="text-align: center;">Próximos Partidos</h2><br>
